...
def setup_telemetry() -> str | None:
    """Configure OpenTelemetry and GenAI telemetry with GCS upload, and setup stdout logging."""
    ...
    if log_format == "JSON":
        ...
        # Cloud Run automatically maps 'severity' to the log level
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=hr-onboarding,service.version={commit_sha}",
        )
